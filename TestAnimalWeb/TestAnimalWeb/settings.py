"""
Django settings for TestAnimalWeb project.
...
SECRET_KEY = '^lqsj)+st8ek0t$whr#u=^4g556q!+j)i#vn-c)jj1jd2zjl79'
...
ROOT_URLCONF = 'TestAnimalWeb.urls'
...
WSGI_APPLICATION = 'TestAnimalWeb.wsgi.application'
